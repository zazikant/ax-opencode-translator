...
- When the user asks for "expanded" or "multi-line" telegraphic speech with "causal chains" — for EACH source keyword, generate 3-5 separate lines. Each line starts with that keyword (capitalized) and spawns a causal chain of 3 clauses, 6-8 words per clause, separated by semicolons, one chain per line. NO bold headings. NO headings at all. Each line is self-contained. Format: "Keyword verb object; verb adjective; verb adverb;" — one line per chain, newline between lines. Example for "Rain": "Rain floods the valley; rivers swell; bridges collapse;" on one line, "Rain nourishes the soil; roots deepen; harvests multiply;" on the next line.
